...
const styles = StyleSheet.create({
    ...
    searchBar: {
        ...
        marginBottom: 10,
        borderWidth: 1, // Añadido borde negro
    ...
    messageItem: {
        backgroundColor: 'rgba(0,0,0,0.15)', // Fondo más oscuro para los mensajes
        paddingVertical: 10,
        paddingHorizontal: 15,
        marginHorizontal: 15,
        marginBottom: 5,
    ...
    messageText: {
        color: '#000', // Texto más claro en los mensajes
    },
    timeText: {
        color: '#000', // Texto más suave para la hora
    },
    navbar: {
        flexDirection: 'row',
